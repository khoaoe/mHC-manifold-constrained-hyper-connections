"""
Downloads and tokenizes TinyStories-GPT4-Clean dataset using Qwen2.5-0.5B tokenizer.
...
def main():
    parser = argparse.ArgumentParser(description="Download and pre-tokenize TinyStories-GPT4-Clean")
    parser.add_argument("--output-dir", type=str, default="data/tinystories", help="Output directory for shards")
    ...
    print(f"📥 Loading dataset 'karpathy/tinystories-gpt4-clean' from Hugging Face...")
    ...
    for entry in tqdm(dataset, desc="Processing documents"):
        ...
        while len(token_buffer) >= args.shard_size:
            ...
            shard_path = os.path.join(args.output_dir, f"tinystories_{shard_idx:05d}.bin")
